...
let navegacion = {
    ...
    IraHome: function() {
        var url = "http://localhost/practicas/home/index.html";
        navegacion.navegar(url);
    },

    IraPracticasGaston: function() {
        var url = "http://localhost/practicas/practicasgaston/index.html";
        navegacion.navegar(url);
    },
    IraTodoApp: function() {
        var url = "http://localhost/practicas/todoapp/index.html";
        navegacion.navegar(url);
    },
    IraJqueryTable: function() {
        var url = "http://localhost/practicas/jquerytabla/index.html";
        navegacion.navegar(url);
